...
public_users.get('/', async function (req, res) {
    try {
      const response = await axios.get('https://damianbutows-5000.theiadocker-0-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/books');
...
public_users.get('/isbn/:isbn',function (req, res) {
 ...
 public_users.get('/isbn/:isbn', async function (req, res) {
    try {
      ...
      const response = await axios.get('https://damianbutows-5000.theiadocker-0-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/books/${isbn}');
...
public_users.get('/author/:author', async function (req, res) {
    try {
      ...
      const response = await axios.get(`https://damianbutows-5000.theiadocker-0-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/books?author=${author}`);
...
public_users.get('/title/:title', async function (req, res) {
    try {
      ...
      const response = await axios.get(`https://damianbutows-5000.theiadocker-0-labs-prod-theiak8s-4-tor01.proxy.cognitiveclass.ai/books?title=${title}`);
